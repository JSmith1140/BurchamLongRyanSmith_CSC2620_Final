    ...
    public boolean sendMoneyToUser(String recipient, double amount, boolean fromChecking) {
        ...
        try {
            ...
            liveOut.println("SEND:" + recipient + "," + amount + "," + "checking"); // Force recipient's account to checking
    ...
    public boolean sendRequestToUser(String recipient, double amount, boolean toChecking) {
        try {
            ...
            responseQueue.clear();
            liveOut.println("REQUEST:" + recipient + "," + amount + "," + "checking"); // Recipient will pay from checking
